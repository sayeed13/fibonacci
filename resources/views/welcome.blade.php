<x-guest-layout>
    <div class="relative z-10 pt-48 pb-52 bg-cover bg-center" style="background-image: url(/img/hero-bg.jpg)">
        <div class="absolute h-full w-full bg-black opacity-60 top-0 left-0 z-10"></div>
        <div class="container relative z-20 text-white text-center text-2xl">
            <h2 class="font-bold text-5xl mb-8">Lorem ipsum dolor sit amet,<br /> consectetur adipisicing elit. Fuga,
                totam.</h2>
    ...
    <div class="py-32 text-center">
        <div class="container">
            <h2 class="font-bold text-4xl mb-6">Lorem ipsum dolor sit amet, consectetur<br /> adipisicing elit. A aut
                autem dolorum <span class="underline">quis vitae!</span></h2>
            ...
            <h2 class="font-bold text-4xl mb-6 mt-20">Lorem ipsum dolor sit amet adipisicing<br /> adipisicing elit. A
                aut lorum <span class="underline">quis vitae!</span></h2>
    ...
    <div class="container text-center pt-14">
        ...
        <div class="relative mt-10 mb-14 bg-cover rounded-xl py-24 bg-center"
            style="background-image: url('/img/sand.jpg')">
    ...
    <div class="container pt-14">
        <div class="flex justify-between ">
            ...
            <div class="flex-1 ml-10">
                <img class="rounded" src="/img/sand.jpg" alt="">
            </div>
        </div>
    </div>
    <div class="container pt-14">
